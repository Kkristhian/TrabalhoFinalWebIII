...
<form action="/api/genero" method="POST">
        <div class="form-group">
            <label for="id">Código do Genero:</label>
            <input type="number" required readonly value="{{ $id }}" name="id" id="id" required class="form-control" placeholder="Código do Genero">
        </div>
        <div class="form-group">
