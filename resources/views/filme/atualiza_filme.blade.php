...
<form action="/api/filme" method="PUT">
        ...
        <div class="form-group">
            ...
            <input type="number" name="est_id" value="{{ $model->est_id }}" id="est_id" required class="form-control" placeholder="Código do Estudio">

            <select id="est_id" name="est_id" class="form-control">
                @foreach ($estudios as $estudio)
                    <option value="{{ $model->id }}">{{ $estudio->nome_estudio }}</option>
                @endforeach
            </select>
        </div>
        <div class="form-group">
            <label for="dir_codigo">Código do Diretor:</label>
            <input type="number" name="dir_codigo" value="{{ $model->dir_codigo }}" id="dir_codigo" required class="form-control" placeholder="Código do Diretor">
       
            <select id="dir_codigo" name="dir_codigo" class="form-control">
                @foreach ($estudios as $estudio)
                    <option value="{{ $model->id }}">{{ $estudio->tipo }}</option>
                @endforeach
            </select>
        </div>
        <div class="form-group">
            <label for="gen_codigo">Genero:</label>
            <input type="number" name="gen_codigo" value="{{ $model->gen_codigo }}" id="gen_codigo" required class="form-control" placeholder="Código do Gênero">
